      ...
      <div className="p-8">
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          ...
          <div className="flex gap-2 mb-6">
            <button className="px-4 py-2 bg-purple-600 text-white rounded-lg text-sm font-medium">All Students</button>
            <button className="px-4 py-2 bg-gray-700 text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-600">10A</button>
            <button className="px-4 py-2 bg-gray-700 text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-600">10B</button>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="text-gray-300">
                {[1,2,3,4].map((i) => (
                  <tr key={i} className="border-b border-gray-700/50 hover:bg-gray-900/50">
                    <td className="py-4">
